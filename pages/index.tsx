          ...
          <div className="lg:w-1/2">
            ...
            <section className="px-6 pb-20 pt-4 md:pb-0 lg:flex lg:space-x-4">
              ...
              <button
                ...
                className="mt-4 flex w-full items-center justify-center gap-4 rounded-lg bg-orange py-3 font-semibold text-white shadow-md shadow-orange hover:bg-opacity-90 lg:w-[55%]"
              >
